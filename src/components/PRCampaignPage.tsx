...
const keyDates: { date: string; title: string; desc: string }[] = [
  ...
  { date: 'Mon, Jul 6', title: 'Announcement + Login Email', desc: 'Emails to all clients (sign in to see certain pricing).' },
  { date: 'Sun, Jul 26', title: 'NIL Last Order Date', desc: 'Final day to place orders on the New Image Labs website.' },
  { date: 'Mon, Jul 27', title: 'Migration + Welcome Email', desc: 'Customer accounts & companies migrate (orders do not). Welcome email with 10% off the first online order.' },
...
export const accountWorkflows: AccountWorkflow[] = [
  {
    ...
    who: 'For a current NIL / OnRite customer',
    steps: [
      { label: 'Sales creates the account', desc: 'Company + user set up in the admin with their existing pricing tier. No form needed.' },
      { label: 'Account live', desc: 'Client signs in (no password — secure link) and sees their tier pricing.', final: true },
    ],
    emails: [
      'Auto welcome email: "We\'ve transferred your account to Hairloss.com. Continue shopping with your pricing tier."',
    ],
    note: 'Sales sets up both the company and the user — the client never fills out a form.',
  },
  {
    num: 'Workflow 2',
  ...
  },
  {
    ...
    who: 'Signed up with just an email, no form yet',
    steps: [
      { label: 'Signs up with email', desc: 'Account created with no business info — they see retail pricing.' },
      { label: 'Gets a welcome email', desc: 'Prompts them to fill out the B2B form if they\'re a business.', final: true },
    ],
    emails: [
      'Auto welcome email: "If you\'re a business, salon, stylist, or barber, fill out the form for wholesale pricing."',
    ],
    note: 'Filling out the form sends them into Workflow 2. If they don\'t, they stay a retail customer.',
  },
]
...
const salesContent: Record<'en' | 'es', SalesContent> = {
  en: {
    ...
    script: [
      { cue: 'Greeting', line: '"Hello, may I speak with [Customer Name]?"' },
      { cue: 'Opening', line: '"Hi [Customer Name], this is [Your Name] calling from New Image and Hair Visions. How are you today? I\'m calling with some exciting news."' },
      { cue: 'Why we\'re upgrading', line: '"At New Image and Hair Visions, we\'re always looking for ways to improve your experience and make ordering easier. That\'s why we\'re bringing all of our products together on one convenient platform: Hairloss.com."' },
      { cue: 'Launch & support', line: '"Our new website will launch on August 3rd and will allow you to shop online while continuing to receive personalized support from your Sales Representative whenever needed."' },
      { cue: 'Your account', line: '"If you currently have an online account with New Image, you\'ll receive an activation email with instructions on how to access your account on Hairloss.com. If you do not currently have an online account with New Image or Hair Visions, we would be happy to set one up for you. Would you like us to do that? Great! I can either transfer your call now, or if you prefer, Mariana can give you a call back to assist with setting up your account."' },
      { cue: 'Past orders', line: '"Please note that previous online orders will not appear in your Hairloss.com order history, but we will be happy to assist you with any past order information."' },
      { cue: 'Order through July 26', line: '"You can continue placing orders through NewImageLabs.com until July 26th. After that, you\'ll be redirected to Hairloss.com."' },
      { cue: 'Watch your email', line: '"Be sure to watch for your activation email, along with one welcome email that includes 10% off your first online order on Hairloss.com."' },
      { cue: 'Close', line: '"Do you have any questions I can answer for you today? Thank you for your continued support. We look forward to welcoming you to Hairloss.com!"' },
      { cue: 'Stay aligned', line: '"[Team note — say this internally, not to the client] We all give the customer the same story: order on NewImageLabs.com until July 26, Hairloss.com launches August 3, watch for the activation email + a welcome email with 10% off the first online order, and we help with any past-order info. Same dates, same message, every call."' },
    ],
    faqIntro: 'The questions customers will ask — and how to answer them.',
    faq: [
      { q: 'So what is Hairloss.com now?', a: 'Hairloss.com is the new e-commerce platform for NIL and OR. You\'ll find everything we offer in one place, making the shopping experience easier for you.' },
      ...
      { q: 'What happens to my order history?', a: 'Your previous online orders won\'t appear in your Hairloss.com order history, but your sales rep is happy to assist you with any past order information.' },
      ...
      { q: 'What if I can\'t find a product I previously purchased?', a: 'Just call your rep — they\'ll point you right to it. Everything you order is or will be on Hairloss.com.' },
      { q: 'Can I still place orders on the current website?', a: 'Yes — you can keep ordering on the New Image Labs site through Sunday, July 26. That\'s the last day for online orders there.' },
      ...
      { q: 'Can I track existing orders after the transition?', a: 'Yes. Orders placed before the move are still fulfilled and tracked as usual. Your previous orders won\'t appear in your Hairloss.com history, but your sales rep can assist with any past order information.' },
  ...
  es: {
    ...
    script: [
      { cue: 'Saludo', line: '"Hola, ¿puedo hablar con [Nombre del Cliente]?"' },
      { cue: 'Apertura', line: '"Hola [Nombre del Cliente], le habla [Su Nombre] de New Image y Hair Visions. ¿Cómo está hoy? Le llamo con una noticia muy emocionante."' },
      { cue: 'Por qué mejoramos', line: '"En New Image y Hair Visions siempre buscamos formas de mejorar su experiencia y facilitar sus pedidos. Por eso estamos reuniendo todos nuestros productos en una sola plataforma conveniente: Hairloss.com."' },
      { cue: 'Lanzamiento y soporte', line: '"Nuestro nuevo sitio se lanza el 3 de agosto y le permitirá comprar en línea mientras sigue recibiendo el apoyo personalizado de su Representante de Ventas siempre que lo necesite."' },
      { cue: 'Su cuenta', line: '"Si actualmente tiene una cuenta en línea con New Image, recibirá un correo de activación con instrucciones sobre cómo acceder a su cuenta en Hairloss.com. Si aún no tiene una cuenta en línea con New Image o Hair Visions, con gusto le configuramos una. ¿Le gustaría que lo hagamos? ¡Perfecto! Puedo transferir su llamada ahora, o si prefiere, Mariana puede devolverle la llamada para ayudarle a configurar su cuenta."' },
      { cue: 'Pedidos anteriores', line: '"Tenga en cuenta que sus pedidos en línea anteriores no aparecerán en su historial de Hairloss.com, pero con gusto le ayudamos con cualquier información de pedidos anteriores."' },
      { cue: 'Pedidos hasta el 26 de julio', line: '"Puede seguir haciendo pedidos en NewImageLabs.com hasta el 26 de julio. Después de esa fecha, será redirigido a Hairloss.com."' },
      { cue: 'Esté atento a su correo', line: '"Esté atento a su correo de activación, junto con un único correo de bienvenida que incluye 10% de descuento en su primer pedido en línea en Hairloss.com."' },
      { cue: 'Cierre', line: '"¿Tiene alguna pregunta que pueda responderle hoy? Gracias por su continuo apoyo. ¡Esperamos darle la bienvenida a Hairloss.com!"' },
      { cue: 'Alineación del equipo', line: '"[Nota interna del equipo — decir esto entre nosotros, no al cliente] Todos le damos al cliente la misma historia: pedidos en NewImageLabs.com hasta el 26 de julio, Hairloss.com se lanza el 3 de agosto, esté atento al correo de activación + un correo de bienvenida con 10% de descuento en el primer pedido en línea, y ayudamos con cualquier información de pedidos anteriores. Mismas fechas, mismo mensaje, en cada llamada."' },
    ],
    faqIntro: 'Las preguntas que harán los clientes — y cómo responderlas.',
    faq: [
      { q: '¿Y qué es Hairloss.com ahora?', a: 'Hairloss.com es la nueva plataforma de e-commerce de NIL y OR. Encontrará todo lo que ofrecemos en un solo lugar, haciendo su experiencia de compra más fácil.' },
      ...
      { q: '¿Qué pasa con mi historial de pedidos?', a: 'Sus pedidos en línea anteriores no aparecerán en su historial de pedidos de Hairloss.com, pero su representante de ventas con gusto le ayuda con cualquier información de pedidos anteriores.' },
      ...
      { q: '¿Y si no encuentro un producto que compré antes?', a: 'Solo llame a su representante — le indicará exactamente dónde está. Todo lo que usted pide está o estará en Hairloss.com.' },
      { q: '¿Puedo seguir haciendo pedidos en el sitio actual?', a: 'Sí — puede seguir comprando en el sitio de New Image Labs hasta el domingo 26 de julio. Ese es el último día para pedidos en línea ahí.' },
      ...
      { q: '¿Puedo rastrear pedidos existentes después de la transición?', a: 'Sí. Los pedidos hechos antes del cambio se cumplen y rastrean como siempre. Sus pedidos anteriores no aparecerán en su historial de Hairloss.com, pero su representante de ventas le ayuda con cualquier información de pedidos anteriores.' },
...
export const emails: EmailDesign[] = [
  // ── New Image Labs clients (the core B2B migration) ──
  {
    ...
    preview: 'A better shopping experience is coming — here\'s what to know.',
    goal: 'Announce the move and how the account works. Lead with continuity.',
    tone: 'Professional and reassuring. Business to business.',
    body: [
      'We\'re excited to announce that New Image Labs products will soon be available exclusively through Hairloss.com, providing you with a faster, more streamlined shopping experience.',
      'Important dates — July 26: last day to place orders through the New Image Labs website. July 31: the website goes offline at the end of the business day. August 3: the website returns as a landing page that automatically directs you to Hairloss.com to place your orders.',
      'What you need to know — the good news is you don\'t need to do anything. Your account will be transferred, your pricing tier will remain the same, and the products you currently order will all be available on Hairloss.com.',
      'Your sales representative will create your Hairloss.com account, and you\'ll receive an activation email. Signing in is simple — use the same email address the activation email was sent to, receive a one-time verification code, and sign in with no password required.',
      'If you have any questions, please contact your sales representative.',
      'Thank you for your continued business. We look forward to serving you on Hairloss.com!',
    ],
    cta: '',
  },
  {
    ...
    subject: 'Final Week to Order on the New Image Labs Website',
    preview: 'Orders accepted through July 26 — here are the key dates.',
    goal: 'Final reminder ahead of the July 26 cutoff.',
    tone: 'Direct and professional. Business to business.',
    body: [
      'This is the final week to place orders on the New Image Labs website. Orders will be accepted through July 26.',
      'Important dates — July 26: last day to place orders on the New Image Labs website. July 31: the website goes offline at the end of the business day and will be unavailable through the weekend. August 3: the website returns as a landing page that will direct you to Hairloss.com, where you can continue placing your orders.',
      'No action required — your transition to Hairloss.com will be seamless. Your account information will be transferred, your current pricing tier will remain the same, and you\'ll continue ordering the same New Image Labs products.',
      'Once your account has been migrated, you will receive an activation email from Hairloss.com with simple sign-in instructions. Just use the same email address the activation email was sent to and enter the one-time verification code — no password required.',
      'If you have any questions, please contact your sales representative.',
      'Thank you for your continued business. We look forward to seeing you on Hairloss.com.',
    ],
    cta: '',
  },
  {
    ...
    subject: 'Welcome to Hairloss.com!',
    preview: 'Your account has been migrated — activate it and save 10%.',
    ...
    body: [
      'We\'re pleased to let you know that your New Image Labs account has been successfully migrated to Hairloss.com.',
      'You can now continue shopping with the same pricing tier, account privileges, and products you\'ve always enjoyed — now on one convenient platform.',
      'Activate your account: you will receive an activation email from Hairloss.com. Getting started is easy — use the same email address the activation email was sent to, enter the one-time verification code sent to your inbox, and no password is required.',
      'Welcome offer: enjoy 10% OFF your first online order on Hairloss.com! It\'s our way of saying thank you for your continued loyalty.',
      'If your pricing is not displayed correctly after signing in, please contact your sales representative and we\'ll be happy to assist you.',
      'Thank you for your continued business. We look forward to serving you on Hairloss.com.',
    ],
    cta: '',
  },
  ...
  },
  {
    ...
    send: 'July 28–30',
    timing: 'Pre-launch',
    subject: 'New Website launches August 3',
    preview: 'Create your professional account so your pricing is ready at launch.',
    ...
    body: [
      'We\'re excited to introduce Hairloss.com — your new online destination for purchasing OnRite products. Designed to make ordering easier, faster, and more convenient, Hairloss.com brings everything together in one place.',
      'Create your professional account today: to ensure your professional pricing is ready when Hairloss.com launches on August 3, please have your sales representative create your account in advance.',
      'Signing in is simple — use the email address associated with your account, receive a one-time verification code by email, and no password is required.',
      'Welcome offer: as a thank-you for joining Hairloss.com, you\'ll receive 10% OFF your first online order.',
      'If you have any questions or need assistance setting up your account, please contact your sales representative.',
      'We look forward to welcoming you to Hairloss.com.',
    ],
  ...
  },
  {
    ...
    send: 'August 3',
    timing: 'Launch day',
    subject: 'Hairloss.com Is Now Live – Sign In & Save 10%',
    preview: 'Sign in to your professional account and save 10% on your first order.',
    goal: 'Launch. Drive first sign-in and first order for OnRite customers.',
    tone: 'Professional and welcoming. Business to business.',
    body: [
      'Hairloss.com is officially live! Sign in to your professional account to view your personalized pricing and shop a selection of OnRite products, along with the complete New Image Labs catalog — all in one convenient location.',
      'Don\'t forget your welcome offer: as a thank-you for joining Hairloss.com, you\'ll receive 10% OFF your first online order.',
      'Get started today — sign in to your professional account, view your personalized pricing, shop a selection of OnRite products and the complete New Image Labs catalog, and redeem your 10% welcome discount on your first online purchase.',
      'If you have not yet created your account, or if your pricing is not displayed after signing in, please contact your sales representative and we\'ll be happy to assist you.',
      'Thank you for choosing OnRite. We look forward to seeing you on Hairloss.com.',
    ],
    cta: 'Sign In to Hairloss.com',
  },
  ...
  // ── Hairloss.com customers (retail / consumer) ──
  {
    ...
    send: 'July 6',
    timing: '~4 weeks before launch',
    subject: 'Hairloss.com is undergoing some changes',
    preview: 'We\'re temporarily unavailable online — here\'s how to keep ordering.',
    goal: 'Let retail customers know the site is temporarily unavailable online + how to order.',
    tone: 'Friendly, clear, consumer-facing.',
    body: [
      'We wanted to let you know that Hairloss.com is undergoing some changes and will be temporarily unavailable for online purchasing.',
      'To continue purchasing in the meantime, please contact us — we\'re happy to help with your order.',
      'Email: info@hairloss.com',
      'Toll Free: +1.855.HAIR.601 (+1.855.4247.601)',
      'Thank you for your patience. We can\'t wait to welcome you back to the new Hairloss.com.',
    ],
    cta: '',
  },
  {
