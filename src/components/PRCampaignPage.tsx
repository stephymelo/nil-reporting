...
export const emails: EmailDesign[] = [
  ...
  },
  {
    ...
    body: [
      'As we prepare to bring everything together on Hairloss.com, we want to walk you through how your account will work so the transition is seamless for your business.',
      'There are two dates to keep in mind. On Saturday, August 1, the New Image Labs website will go offline for maintenance over the weekend. Beginning Monday, August 3, all online ordering will take place on Hairloss.com.',
      'There is nothing for you to set up. Your sales representative will create your account on your behalf, and you will receive an activation email from Hairloss.com. To sign in, simply use the same email address the message was sent to.',
      'For added security and convenience, sign-in is passwordless. Rather than managing a password, you will enter your email and receive a one-time code to access your account.',
      'Your pricing will remain securely tied to your account. To protect our wholesale pricing, prices are not displayed publicly; once you sign in, you will see your tier pricing — the same pricing you have today. You will continue to recognize the products you order, as the full catalog will be available on the site.',
      'If you have any questions, please contact your sales representative.',
    ],
    cta: '',
  },
  {
    ...
    body: [
      'As we approach the move to Hairloss.com, we want to remind you that this is the final week to place orders on the New Image Labs website.',
      'On Saturday, August 1, the New Image Labs website will go offline for maintenance over the weekend. Beginning Monday, August 3, orders will no longer be placed on the New Image Labs website, and all online ordering will take place on Hairloss.com.',
  ...
  },
  {
    ...
    body: [
      ...
      'If you have not yet received your activation email, please contact your sales representative and we will ensure you are set up right away.',
    ],
