...
const salesContent: Record<'en' | 'es', SalesContent> = {
  en: {
    ...
    script: [
      ...
      { cue: 'Your account', line: '"If you currently have an online account with New Image, you\'ll receive an activation email with instructions to access your account on Hairloss.com. If you do not currently have an online account with New Image or Hair Visions, we would be happy to create one for you."' },
      ...
      { cue: 'Watch your email', line: '"Be sure to watch for your activation email and a welcome email that will include 10% off your first online order on Hairloss.com."' },
  ...
  es: {
    ...
    script: [
      ...
      { cue: 'Su cuenta', line: '"Si actualmente tiene una cuenta en línea con New Image, recibirá un correo de activación con instrucciones para acceder a su cuenta en Hairloss.com. Si aún no tiene una cuenta en línea con New Image o Hair Visions, con gusto le creamos una."' },
      ...
      { cue: 'Esté atento a su correo', line: '"Esté atento a su correo de activación y a un correo de bienvenida que incluirá 10% de descuento en su primer pedido en línea en Hairloss.com."' },
