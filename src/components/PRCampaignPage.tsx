...
export const emails: EmailDesign[] = [
  ...
  },
  {
    ...
    body: [
      ...
      'Two dates to note: on August 1, the New Image Labs website goes offline for maintenance over the weekend. From August 3, all ordering is on Hairloss.com — there are no more orders on the New Image Labs website.',
  ...
  },
  {
    ...
    body: [
      ...
      'On August 1, the New Image Labs website goes offline for maintenance over the weekend. From August 3, there are no more orders on the New Image Labs website — everything is on Hairloss.com.',
  ...
  },
  {
    ...
    body: [
      'The New Image Labs website is offline this weekend for maintenance.',
      'From Monday, August 3, all ordering is on Hairloss.com — with your account, pricing, and order history in place. There are no more orders on the New Image Labs website after this weekend.',
