...
const salesContent: Record<'en' | 'es', SalesContent> = {
  en: {
    ...
    script: [
      ...
      { cue: 'Order through July 26', line: '"You can keep ordering online on the New Image Labs site through Saturday, July 26 — that\'s the last day for online orders there. So nothing changes for you between now and then."' },
      ...
      { cue: 'Your data migrates', line: '"Because you\'re a New Image Labs customer, your customer info and your company/business details will migrate on Sunday, July 27, and be visible on Hairloss.com. You\'ll also get a welcome email that day with 10% off your first online order. (Note: past orders do not carry over.)"' },
  ...
  es: {
    ...
    script: [
      ...
      { cue: 'Pedidos hasta el 26 de julio', line: '"Puede seguir haciendo pedidos en línea en el sitio de New Image Labs hasta el sábado 26 de julio — ese es el último día para pedidos en línea ahí. Así que nada cambia para usted entre ahora y esa fecha."' },
