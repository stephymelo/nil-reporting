...
const salesContent: Record<'en' | 'es', SalesContent> = {
  en: {
    ...
    script: [
      ...
      { cue: 'The change', line: '"We\'re bringing everything onto one website — Hairloss.com. Starting Monday, August 3, you\'ll order there instead of the New Image Labs site."' },
      { cue: 'Reassure', line: '"Your pricing tier and the products you order stay exactly the same. Nothing you rely on is going away."' },
      { cue: 'Order through July 26', line: '"You can keep ordering online on the New Image Labs site through Sunday, July 26 — that\'s the last day for online orders there. So nothing changes for you between now and then."' },
      ...
      { cue: 'Your data migrates', line: '"Because you\'re a New Image Labs customer, your customer info and your company/business details will migrate on Monday, July 27, and be visible on Hairloss.com. You\'ll also get a welcome email that day with 10% off your first online order. (Note: past orders do not carry over.)"' },
      { cue: 'The weekend gap', line: '"The New Image Labs site goes offline at the end of the day Friday, July 31 for the weekend. Then on Monday, August 3 it\'s back — ordering happens on Hairloss.com from that day on."' },
      { cue: 'Close', line: '"I\'ll send your login before August 3 so you\'re ready, and don\'t forget that 10% off your first online order. Any questions, you call me directly."' },
      { cue: 'Stay aligned', line: '"[Team note — say this internally, not to the client] We all give the customer the same story: order on NIL through July 26, site offline end of day Friday July 31, back online for ordering on Hairloss.com Monday August 3, and 10% off the first online order. Same dates, same message, every call."' },
    ],
  ...
  es: {
    ...
    script: [
      ...
      { cue: 'El cambio', line: '"Estamos reuniendo todo en un solo sitio — Hairloss.com. A partir del lunes 3 de agosto, hará sus pedidos ahí en lugar del sitio de New Image Labs."' },
      ...
      { cue: 'Pedidos hasta el 26 de julio', line: '"Puede seguir haciendo pedidos en línea en el sitio de New Image Labs hasta el domingo 26 de julio — ese es el último día para pedidos en línea ahí. Así que nada cambia para usted entre ahora y esa fecha."' },
      ...
      { cue: 'Migración de sus datos', line: '"Como usted es cliente de New Image Labs, su información de cliente y los datos de su empresa/negocio se migran el domingo 27 de julio y estarán visibles en Hairloss.com. Ese mismo día también recibirá un correo de bienvenida con 10% de descuento en su primer pedido en línea. (Nota: los pedidos anteriores no se transfieren.)"' },
      { cue: 'El fin de semana', line: '"El sitio de New Image Labs se desconecta al final del día el viernes 31 de julio durante el fin de semana. Luego, el lunes 3 de agosto vuelve — a partir de ese día los pedidos se hacen en Hairloss.com."' },
      { cue: 'Cierre', line: '"Le enviaré su acceso antes del 3 de agosto para que esté listo, y no olvide ese 10% de descuento en su primer pedido en línea. Cualquier pregunta, llámeme directamente."' },
      { cue: 'Alineación del equipo', line: '"[Nota interna del equipo — decir esto entre nosotros, no al cliente] Todos le damos al cliente la misma historia: pedidos en NIL hasta el 26 de julio, sitio fuera de línea al final del día el viernes 31 de julio, de vuelta en línea para pedidos en Hairloss.com el lunes 3 de agosto, y 10% de descuento en el primer pedido en línea. Mismas fechas, mismo mensaje, en cada llamada."' },
    ],
