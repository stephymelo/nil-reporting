...
export const emails: EmailDesign[] = [
  // ── New Image Labs clients (the core B2B migration) ──
  {
    ...
    preview: 'Same products, same pricing, one platform — plus how your account will work.',
    goal: 'Announce the move, the sign-in-for-pricing change, and how the account works.',
    ...
    body: [
      ...
      'Your account is being migrated for you — your sales representative will create it, and you will receive an activation email from Hairloss.com. Sign-in is passwordless: you simply enter your email and receive a one-time code. Signing in to your Hairloss.com account will be available in August, once your account has been migrated.',
      'A note on dates: orders on the New Image Labs site run through July 26. From August 3, everything is on Hairloss.com.',
      'There is no action required today. If you have any questions, please contact your sales representative.',
    ],
    cta: '',
  },
  {
