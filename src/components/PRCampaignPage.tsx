...
const salesContent: Record<'en' | 'es', SalesContent> = {
  en: {
    ...
    faq: [
      ...
      { q: 'Will my saved addresses and payment methods transfer?', a: 'Your account and your company/business details migrate with you, so your information is already there when you sign in. For security, payment details are entered at checkout rather than transferred.' },
  ...
  es: {
    ...
    faq: [
      ...
      { q: '¿Se transferirán mis direcciones y métodos de pago guardados?', a: 'Su cuenta y los datos de su empresa/negocio se migran con usted, así que su información ya está ahí cuando inicia sesión. Por seguridad, los datos de pago se ingresan al pagar en lugar de transferirse.' },
