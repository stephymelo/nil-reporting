...
const salesContent: Record<'en' | 'es', SalesContent> = {
  en: {
    ...
    script: [
      { cue: 'Opening', line: '"Hi [name], this is [your name] with New Image and Hair Visions, calling with some great news."' },
      { cue: 'Why we\'re upgrading', line: '"New Image and Hair Visions is always striving to bring you the latest technology and to improve your experience with us. We\'re upgrading our ordering process by putting all our products on one website to make ordering easier — now you can order online, or you can contact your Brand Ambassador."' },
      { cue: 'Launch & your account', line: '"Our new platform, Hairloss.com, launches Monday, August 3. If you have an existing account on the New Image website, you\'ll receive an activation letter — just use that email to log in and see all your information."' },
      { cue: 'Past purchases', line: '"Please note: past purchases made on the New Image website won\'t appear in your history on Hairloss.com. If you need information on a past purchase, your Brand Ambassador can help."' },
      { cue: 'Order through July 26', line: '"You can continue to order online at Newimagelabs.com until July 26. After that, there will be a link on the New Image website directing you to Hairloss.com."' },
      { cue: 'Watch your email', line: '"Be sure to watch your email for your activation letter — and a welcome letter to Hairloss.com offering you 10% off your first order."' },
      { cue: 'Stay aligned', line: '"[Team note — say this internally, not to the client] We all give the customer the same story: order on Newimagelabs.com until July 26, Hairloss.com launches Monday, August 3, watch for the activation letter + a welcome letter with 10% off the first order, and Brand Ambassadors help with any past-purchase info. Same dates, same message, every call."' },
    ],
  ...
  es: {
    ...
    script: [
      { cue: 'Apertura', line: '"Hola [nombre], le habla [su nombre] de New Image y Hair Visions, llamando con una excelente noticia."' },
      { cue: 'Por qué mejoramos', line: '"En New Image y Hair Visions siempre buscamos traerle la última tecnología y mejorar su experiencia con nosotros. Estamos mejorando nuestro proceso de pedidos reuniendo todos nuestros productos en un solo sitio para que ordenar sea más fácil — ahora puede pedir en línea, o puede contactar a su Brand Ambassador."' },
      { cue: 'Lanzamiento y su cuenta', line: '"Nuestra nueva plataforma, Hairloss.com, se lanza el lunes 3 de agosto. Si tiene una cuenta existente en el sitio de New Image, recibirá una carta de activación — solo use ese correo para iniciar sesión y ver toda su información."' },
      { cue: 'Compras anteriores', line: '"Tenga en cuenta: las compras anteriores hechas en el sitio de New Image no aparecerán en su historial en Hairloss.com. Si necesita información sobre una compra anterior, su Brand Ambassador puede ayudarle."' },
      { cue: 'Pedidos hasta el 26 de julio', line: '"Puede seguir haciendo pedidos en línea en Newimagelabs.com hasta el 26 de julio. Después de esa fecha, habrá un enlace en el sitio de New Image que lo dirige a Hairloss.com."' },
      { cue: 'Esté atento a su correo', line: '"Esté atento a su correo para recibir su carta de activación — y una carta de bienvenida a Hairloss.com que le ofrece 10% de descuento en su primer pedido."' },
      { cue: 'Alineación del equipo', line: '"[Nota interna del equipo — decir esto entre nosotros, no al cliente] Todos le damos al cliente la misma historia: pedidos en Newimagelabs.com hasta el 26 de julio, Hairloss.com se lanza el lunes 3 de agosto, esté atento a la carta de activación + una carta de bienvenida con 10% de descuento en el primer pedido, y los Brand Ambassadors ayudan con información de compras anteriores. Mismas fechas, mismo mensaje, en cada llamada."' },
    ],
