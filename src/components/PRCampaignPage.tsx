...
const emails: EmailDesign[] = [
  ...
  },
  {
    ...
    body: [
      'Here is how your account will work on Hairloss.com.',
      'Two dates to note: on August 1, the New Image Labs website goes offline for maintenance and the domain transfers to the new NIL & Onrite landing page while we migrate over the weekend. On August 3, there are no more orders on the New Image Labs website — everything is on Hairloss.com.',
      'Your sales representative is creating your account for you. You will receive an activation email from Hairloss.com — sign in using the same email address it was sent to.',
      'Sign-in is passwordless: enter your email and we send a one-time code. There are no passwords to manage.',
      'Your pricing remains behind your account. To protect wholesale pricing, prices are not shown publicly. Once you sign in to your B2B account, you will see your tier pricing — the same pricing you have today.',
      'You will recognize your products: the full catalog is on the site, and only pricing requires sign-in.',
  ...
  },
  {
    ...
    preview: 'Ordering moves to Hairloss.com on August 3.',
    goal: 'Final reminder ahead of the migration weekend.',
    tone: 'Direct and professional. Business to business.',
    body: [
      'This is the final week to place orders on the New Image Labs website.',
      'On August 1, the website goes offline for maintenance and the domain transfers to the new NIL & Onrite landing page. We migrate over the weekend, and by August 3 there are no more orders on the New Image Labs website — everything is on Hairloss.com.',
      'Your account, your pricing tier, and your products move with you. Once your account is created, you will receive an automatic email from Hairloss.com to sign in.',
      'For more information, please contact your sales representative.',
    ],
    cta: '',
  },
  {
    ...
    preview: 'Maintenance and domain transfer — back on Hairloss.com Monday, August 3.',
    ...
    body: [
      'On August 1, the New Image Labs website goes offline for maintenance while we transfer the domain to the new NIL & Onrite landing page.',
      'We are migrating everything to Hairloss.com over the weekend and bringing it together in one place.',
      'By Monday, August 3, there are no more orders on the New Image Labs website — everything is on Hairloss.com, with your account, pricing, and order history in place.',
  ...
  },
  {
    ...
    body: [
      'Hairloss.com is now live. New Image Labs and Onrite are together on one platform.',
      'Sign in with your account to view your pricing, browse your products, and place orders.',
      'Everything is in one place: your full catalog, your tier pricing, and the promotions and volume pricing available to your business.',
      'If you have not received your activation email, please contact your sales representative.',
    ],
